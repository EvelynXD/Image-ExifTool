...
#     LICENSE => q[perl]
#     META_MERGE => { recommends=>{ Archive::Zip=>q[0], Compress::Raw::Lzma=>q[0], Compress::Zlib=>q[0], Digest::MD5=>q[0], Digest::SHA=>q[0], IO::Compress::Brotli=>q[0], IO::Compress::RawDeflate=>q[0], IO::Uncompress::Brotli=>q[0], IO::Uncompress::RawInflate=>q[0], POSIX::strptime=>q[0], Time::HiRes=>q[0] } }
...
DISTVNAME = Image-ExifTool-12.64
...
manifypods : pure_all config  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) -u \
	  ...
	  lib/Image/ExifTool/7Z.pm $(INST_MAN3DIR)/Image::ExifTool::7Z.$(MAN3EXT) \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) -u \
	  ...
	  lib/Image/ExifTool/InfiRay.pm $(INST_MAN3DIR)/Image::ExifTool::InfiRay.$(MAN3EXT) \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) -u \
	  ...
	  lib/Image/ExifTool/WPG.pm $(INST_MAN3DIR)/Image::ExifTool::WPG.$(MAN3EXT) \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version: '\''12.64'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "version" : "12.64",' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="Image-ExifTool" VERSION="12.64">' > Image-ExifTool.ppd
	...
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="x86_64-linux-gnu-thread-multi-5.36" />' >> Image-ExifTool.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  ...
	  'lib/Image/ExifTool/7Z.pm' 'blib/lib/Image/ExifTool/7Z.pm' \
	...
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  ...
	  'lib/Image/ExifTool/InfiRay.pm' 'blib/lib/Image/ExifTool/InfiRay.pm' \
	...
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  ...
	  'lib/Image/ExifTool/WPG.pm' 'blib/lib/Image/ExifTool/WPG.pm' \
